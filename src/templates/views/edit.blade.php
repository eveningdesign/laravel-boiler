...
<div class="row">
    ...
    <div class="col-sm-12">
        <?php echo "<?php echo \\Form::model($".$names->getSingularInstanceName().", ['route' => [\\App\\Constants\\".$names->getConstantClass()."::UPDATE_ROUTE, $".$names->getSingularInstanceName()."->id]]); ?>".PHP_EOL; ?>
