...
<div class="row">
    ...
    <div class="col-sm-12">
        <?php echo "<?php echo \\Form::model(".$names->getSingularInstanceName().", ['method' => 'PUT', 'route' => [".$names->getNamespacedConstantClass()."::UPDATE_ROUTE, ".$names->getSingularInstanceName()."->id]]); ?>".PHP_EOL; ?>
