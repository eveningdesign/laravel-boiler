...
<div class="row">
    <div class="col-sm-12 text-right">
        ...
        <a href="<?php echo "{{ route(".$names->getNamespacedConstantClass()."::INDEX_ROUTE) }}"; ?>" class="btn btn-default <?php echo \EveningDesign\Boiler\Support\Helpers::getButtonSize(); ?>">View All</a>
    </div>
</div>
<div class="row">
