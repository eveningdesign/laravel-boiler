...
@endforeach
                    <td>
                        <a href="<?php echo "<?php echo route(".$names->getNamespacedConstantClass()."::SHOW_ROUTE, ".$names->getSingularInstanceName()."->id); ?>"; ?>" class="btn btn-default btn-xs">View</a>
                        <a href="<?php echo "<?php echo route(".$names->getNamespacedConstantClass()."::EDIT_ROUTE, ".$names->getSingularInstanceName()."->id); ?>"; ?>" class="btn btn-warning btn-xs">Edit</a>
                        <div style="display: inline-block;">
                            <?php echo "<?php echo Form::open(['method' => 'DELETE', 'route' => [".$names->getNamespacedConstantClass()."::DESTROY_ROUTE, ".$names->getSingularInstanceName()."->id]]); ?>"; ?>
